    ...
    <div :class="['layout-container', { ...containerClass }]">
        ...
        <div class="layout-content-wrapper">
            ...
            <div class="flex gap-x-4">
                ...
                <!---Nav bar start-->
                <div class="relative w-[330px] content-between">
                    <div class="review gap-y-3 font-lemonada overflow-y-auto p-2 content-between h-full" id="nav">
                        <div>
                            <div class="flex gap-x-1 p-1 bg-white border border-gray-300 rounded-md shadow-xs text-[9px]">
                                <button class="text-gray-100 bg-[#4069e5ff] py-1 px-4 rounded-lg w-1/3" id="review_btn" onclick="on_review()">Review</button>
                                <button class="py-1 px-4 rounded-lg w-1/3" id="action_btn" onclick="on_action()">Action</button>
                                <button class="py-1 px-4 rounded-lg w-1/3" id="tasks_btn" onclick="on_tasks()">Tasks</button>
                            </div>
                            ...
                            <div class="gap-y-2 text-[11px] pt-10" id="review_select_response">
                                ...
                                <div class="flex flex-row justify-between bg-white p-2 border rounded-md mb-2">
                                    <p class="pr-2 w-[85%]">
                                        This project is about editing documentation so you can edit some doc or docx files by uploading from your computer. This project is about editing documentation so you can edit some doc or docx files by
